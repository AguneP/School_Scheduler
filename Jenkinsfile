pipeline {
  ...
  stages {
    stage('Continuous_Integration') {
      steps {
        sh 'F:\\1.DevOps\\2020\\sonar-scanner-3.2.0.1227-ubuntu\\bin\\sonar-scanner.bat -Dsonar.host.url=http://192.168.15.8:8080/ -Dsonar.login=<SONARQUBE_TOKEN> -Dsonar.projectVersion=1.0 -Dsonar.projectKey=python-sample -Dsonar.sources=example-py-pytest'
